...
Contributions to niveristand-telemetry-custom-device are welcome from all!

niveristand-telemetry-custom-device is managed via [git](https://git-scm.com), with the canonical upstream
repository hosted on [GitHub](https://github.com/ni/niveristand-telemetry-custom-device/).
...
See [LICENSE](https://github.com/ni/niveristand-telemetry-custom-device/blob/master/LICENSE)
for details about how niveristand-telemetry-custom-device is licensed.
